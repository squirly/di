...
export function Injectable<
  ...
  D6,
  D7,
  Target extends new (d1: D1, d2: D2, d3: D3, d4: D4, d5: D5, d6: D6, d7: D7) => Service
>(Class: Target & Injectable7<Service, D1, D2, D3, D4, D5, D6, D7>): typeof Class;
...
type Injectable6<Service, D1, D2, D3, D4, D5, D6> = Partial<Binding<Service>> &
  ...
  >;
 type Injectable6<Service, D1, D2, D3, D4, D5, D6, D7> = Partial<Binding<Service>> &
  Inject<
    [
      Binding<D1>,
      Binding<D2>,
